...
gmsh.model.mesh.field.setNumber(3, "DistMin", Rr)
gmsh.model.mesh.field.setNumber(3, "DistMax", C / 2.0)

gmsh.model.mesh.field.add("Threshold", 4)
gmsh.model.mesh.field.setNumber(4, "InField", 2)
gmsh.model.mesh.field.setNumber(4, "SizeMin", Lc2/2)
gmsh.model.mesh.field.setNumber(4, "SizeMax", Lc3)
gmsh.model.mesh.field.setNumber(4, "DistMin", w / 5.0)
gmsh.model.mesh.field.setNumber(4, "DistMax", w)
