...
The first step is generating meshes with MeshGeneration.py in the folder "Mesh". Two meshes are already generated and save here, with cracklengths = 0.3 and 0.5. In the main program I'll use the C=0.3 case.
