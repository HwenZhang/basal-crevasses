...
f=0.8;          % Flotation factor
deltatau=0.1;       % DeltaTau - 'sticky friction'
...
save('NEW_Panel_1250els_GCriterion_NoTractionNewEl_WithWalls_ZhStart=0_03_Dt=0_1_H=1000_W=100_L=1000_f=0_8.mat')
